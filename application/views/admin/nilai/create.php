					...
					<div class="card-body">
						<form enctype="multipart/form-data" autocomplete="off" method="post"
							...
							<div class="form-group row">
								...
								<div class="col-sm-10">
									<input type="text" id="nilai_a" name="nilai_a" class="form-control"
							...
							<div class="form-group row">
								...
								<div class="col-sm-10">
									<input type="text" id="nilai_b" name="nilai_b" class="form-control"
							...
							<div class="form-group row">
								...
								<div class="col-sm-10">
									<input type="text" id="nilai_c" name="nilai_c" class="form-control"
							...
							<div class="form-group row">
								<label class="col-sm-2 col-form-label" for="nilai_d">Keluasan Wawasan Keilmuan Dan
									Penerapannya</label>
								<div class="col-sm-10">
									<input type="text" id="nilai_d" name="nilai_d" class="form-control"
							...
							<div class="form-group row">
								...
								<div class="col-sm-10">
									<input type="text" id="nilai_e" name="nilai_e" class="form-control"
										placeholder="Nilai Kelima">
							...
							<div class="form-group row">
								<label class="col-sm-2 col-form-label" for="nilai_f">Kemampuan Mencapai Target
									Pekerjaan</label>
								<div class="col-sm-10">
									<input type="text" id="nilai_f" name="nilai_f" class="form-control"
										placeholder="Nilai Keenam">
							...
							<div class="form-group row">
								...
								<div class="col-sm-10">
									<input type="text" id="total" name="total" class="form-control"
										placeholder="Total Nilai" readonly="readonly">
						...
						<a href="<?= base_url('data-nilai'); ?>">
							<button class="btn btn-danger btn-block"> <i class="far fa-arrow-alt-circle-left"></i>
								Kembali</button>
						</a>
					</div>
				</div>
